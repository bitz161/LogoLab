...
import Title from '../../design-editor/components/layout/Title';
import FlowContainer from '../../design-editor/containers/FlowContainer';
import { FiberEditor, FlowEditor, HexGridEditor, ImageMapEditor, WorkflowEditor } from '../../design-editor/editors';
...
class Logos extends Component<any, IState> {
	state: IState = {
